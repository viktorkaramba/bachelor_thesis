...
public class UserRankAchievementInfoController {
    ...
    @GetMapping("/user-rank-achievements-info")
    ...
    @GetMapping("/user-rank-achievements-info/{userId}/{rankId}")
    ...
    @PostMapping("/user-rank-achievements-info")
    ...
    @PutMapping("/user-rank-achievements-info")
    ...
    @DeleteMapping("/user-rank-achievements-info/{id}")
